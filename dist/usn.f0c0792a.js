...
},{"base64-js":"../node_modules/base64-js/index.js","ieee754":"../node_modules/ieee754/index.js","isarray":"../node_modules/node-libs-browser/node_modules/isarray/index.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/safe-buffer/index.js":[function(require,module,exports) {
...
},{}],"../node_modules/near-api-js/node_modules/statuses/codes.json":[function(require,module,exports) {
module.exports = {
  "100": "Continue",
...
},{}],"../node_modules/near-api-js/node_modules/statuses/index.js":[function(require,module,exports) {
/*!
 * statuses
...
},{"./codes.json":"../node_modules/near-api-js/node_modules/statuses/codes.json"}],"../node_modules/inherits/inherits_browser.js":[function(require,module,exports) {
...
},{"depd":"../node_modules/near-api-js/node_modules/http-errors/node_modules/depd/lib/browser/index.js","setprototypeof":"../node_modules/setprototypeof/index.js","statuses":"../node_modules/near-api-js/node_modules/statuses/index.js","inherits":"../node_modules/inherits/inherits_browser.js","toidentifier":"../node_modules/toidentifier/index.js"}],"../node_modules/near-api-js/lib/utils/exponential-backoff.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"http-errors":"../node_modules/near-api-js/node_modules/http-errors/index.js","./exponential-backoff":"../node_modules/near-api-js/lib/utils/exponential-backoff.js","../providers":"../node_modules/near-api-js/lib/providers/index.js","./errors":"../node_modules/near-api-js/lib/utils/errors.js"}],"../node_modules/mustache/mustache.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{"bn.js":"../node_modules/near-api-js/node_modules/bn.js/lib/bn.js","depd":"../node_modules/depd/lib/browser/index.js"}],"../node_modules/near-api-js/lib/constants.js":[function(require,module,exports) {
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"bn.js":"../node_modules/near-api-js/node_modules/bn.js/lib/bn.js","depd":"../node_modules/depd/lib/browser/index.js","./transaction":"../node_modules/near-api-js/lib/transaction.js","./providers":"../node_modules/near-api-js/lib/providers/index.js","borsh":"../node_modules/near-api-js/node_modules/borsh/lib/index.js","./utils/key_pair":"../node_modules/near-api-js/lib/utils/key_pair.js","./utils/errors":"../node_modules/near-api-js/lib/utils/errors.js","./utils/rpc_errors":"../node_modules/near-api-js/lib/utils/rpc_errors.js","./constants":"../node_modules/near-api-js/lib/constants.js","./utils/exponential-backoff":"../node_modules/near-api-js/lib/utils/exponential-backoff.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/near-api-js/lib/account_multisig.js":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
'use strict';
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/henprokuror", "/.near/validator_key.json"),
...
},{}],"usn.js":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
"use strict";
...
var nearConfig = (0, _config.default)("mainnet");
...
function connectUSNContract() {
  return _connectUSNContract.apply(this, arguments);
}

function _connectUSNContract() {
  _connectUSNContract = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.next = 5;
            return new nearAPI.Contract(window.walletConnection.account(), "usn", {
          ...
          case 5:
            window.usn_contract = _context.sent;
...
function loadNativeBalance(_x) {
  return _loadNativeBalance.apply(this, arguments);
}

function _loadNativeBalance() {
  _loadNativeBalance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(account_id) {
    var account, balance;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            return _context2.abrupt("return", parseFloat(nearAPI.utils.format.formatNearAmount(balance === null || balance === void 0 ? void 0 : balance.available, 4)));
...
function loadUSNBalances() {
  return _loadUSNBalances.apply(this, arguments);
}

function _loadUSNBalances() {
  _loadUSNBalances = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var account_id, balance;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return connectUSNContract();

          case 3:
            account_id = document.querySelector('#usn-account-id').value;
            ...
            _context4.next = 8;
            return loadNativeBalance(account_id);

          case 8:
            balance = _context4.sent;
            showUsnNearAmount(balance, account_id);
            window.usn_contract.ft_balance_of({
              account_id: account_id
            }).then( /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(amount) {
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        _context3.next = 2;
                        return showUSNAmount(amount, account_id);
...
function GetSignUrl(_x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10) {
  return _GetSignUrl.apply(this, arguments);
}

function _GetSignUrl() {
  _GetSignUrl = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(account_id, method, params, deposit, gas, receiver_id, meta, callback_url, network) {
    var actions, deposit_value, i, _deposit_value, keypair, provider, block, txs, _i, newUrl;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            deposit_value = typeof deposit == 'string' ? deposit : nearAPI.utils.format.parseNearAmount('' + deposit);
            actions = [nearAPI.transactions.functionCall(method, Buffer.from(JSON.stringify(params)), gas, deposit_value)];
            _context5.next = 13;
            break;

          case 7:
            if (!(receiver_id.length === method.length && receiver_id.length === params.length && receiver_id.length === gas.length && receiver_id.length === deposit.length)) {
              _context5.next = 11;
              break;
            }

            for (i = 0; i < receiver_id.length; i++) {
              _deposit_value = typeof deposit[i] == 'string' ? deposit[i] : nearAPI.utils.format.parseNearAmount('' + deposit[i]);
              actions.push([nearAPI.transactions.functionCall(method[i], Buffer.from(JSON.stringify(params[i])), gas[i], _deposit_value)]);
            }
          ...
          case 17:
            ...
            if (typeof receiver_id == 'string') {
              ...
              for (_i = 0; _i < receiver_id.length; _i++) {
                txs.push(nearAPI.transactions.createTransaction(account_id, keypair.publicKey, receiver_id[_i], _i, actions[_i], nearAPI.utils.serialize.base_decode(block.header.hash)));
                console.log(txs);
              }
            }

            newUrl = new URL('sign', 'https://wallet.' + network + '.near.org/');
            newUrl.searchParams.set('transactions', txs.map(function (transaction) {
              return nearAPI.utils.serialize.serialize(nearAPI.transactions.SCHEMA, transaction);
            }).map(function (serialized) {
              return Buffer.from(serialized).toString('base64');
            }).join(','));
            newUrl.searchParams.set('callbackUrl', callback_url);
            if (meta) newUrl.searchParams.set('meta', meta);
            return _context5.abrupt("return", newUrl.href);
...
function showUsnNearAmount(amount_near, account_id) {
  console.log("NEAR balance ".concat(amount_near.toFixed(4)));
...
function showUSNAmount(_x11, _x12) {
  return _showUSNAmount.apply(this, arguments);
}

function _showUSNAmount() {
  _showUSNAmount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(amount, account_id) {
    var amount_usn;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            amount_usn = Math.round(amount / 10000000000) / 100000000;
            console.log("USN balance ".concat(amount_usn.toFixed(4)));
...
function usnWrap() {
  return _usnWrap.apply(this, arguments);
}

function _usnWrap() {
  _usnWrap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    var account_id, amount, amount_near, url;
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            account_id = document.querySelector('#usn-wrap-button').getAttribute('account-id');
            amount = document.querySelector('#usn-near-amount').value;
            amount_near = nearAPI.utils.format.parseNearAmount(amount);
            ...
            _context7.next = 6;
            return GetSignUrl(account_id, "buy", {}, amount_near, 100000000000000, "usn", null, "", "mainnet");
...
function usnUnwrap() {
  return _usnUnwrap.apply(this, arguments);
}

function _usnUnwrap() {
  _usnUnwrap = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    var account_id, amount, amount_usn, url;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            account_id = document.querySelector('#usn-unwrap-button').getAttribute('account-id');
            amount = document.querySelector('#usn-amount').value;
            amount_usn = nearAPI.utils.format.parseNearAmount(amount).substring(0, 18);
            ...
            _context8.next = 6;
            return GetSignUrl(account_id, "sell", {
              "amount": amount_usn
            }, nearAPI.utils.format.parseNearAmount("0.000000000000000000000001"), 100000000000000, "usn", null, "", "mainnet");
...
function checkUsnNearAccountKeyDown(_x13) {
  return _checkUsnNearAccountKeyDown.apply(this, arguments);
}

function _checkUsnNearAccountKeyDown() {
  _checkUsnNearAccountKeyDown = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(e) {
...
function _connect() {
  _connect = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(nearConfig) {
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./config":"config.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","usn.js"], null)
//# sourceMappingURL=/usn.f0c0792a.js.map